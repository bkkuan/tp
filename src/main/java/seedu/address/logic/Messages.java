...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_MEMBER_DISPLAYED_INDEX = "Requires a valid and existing member index. "
            + "Enter LIST to check indexes of existing members.\n";
    ...
    public static final String MESSAGE_INVALID_TASK_DISPLAYED_INDEX = "The task index provided is invalid: %d\n"
            + "Use \"listtasks MEMBER_INDEX\" to check tasks index.";
