...
with(this){return _c('ul',[_c('li',[_v("Deleting a member while all members are being shown")]),_v(" "),_c('li',[_v("List all members using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Multiple members in the list.")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 1")]),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("First contact is deleted from the list. Details of the deleted contact shown in the status message. Timestamp in the status bar is updated.")])])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 0")]),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("No member is deleted. Error details shown in the status message. Status bar remains the same.")])])]),_v(" "),_c('li',[_c('p',[_v("Other incorrect delete commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete x")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("...")]),_v(" (where x is larger than the list size)"),_c('br'),_v(" "),_c('strong',[_v("Expected:")])]),_v(" "),_c('ul',[_c('li',[_v("Similar to previous.")])])])])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"tasks"}},[_v("Tasks"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#tasks","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("Tasks assigned to a member will only accept tasks that are actively being worked on. Tasks with a \"completed\" status and due in the past will not be allowed, as the task system is not intended to store records of completed tasks. Such records will be stored and managed elsewhere.")])]),_v(" "),_c('li',[_c('p',[_v("Since the Tasks feature is not designed to serve as a storage system, it should only accommodate a reasonable number of tasks, ideally between 5 to 10.\nTherefore, there is no need to label tasks on display with an index.")])]),_v(" "),_c('li',[_c('p',[_v("Add a task to a department")])]),_v(" "),_c('li',[_c('p',[_v("Add skills required for a task")])]),_v(" "),_c('li',[_c('p',[_v("Identify gaps in skills required for a task and the members/departments assigned to it")])]),_v(" "),_c('li',[_c('p',[_v("Set task dependencies (e.g. Task B can only start after Task A)")])]),_v(" "),_c('li',[_c('p',[_v("Create subtasks for a task")])])])}
},function anonymous(
) {
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Tue, 8 Apr 2025, 17:11:15 GMT+8]")])])])}
}];
