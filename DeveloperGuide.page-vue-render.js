...
with(this){return _c('ul',[_c('li',[_v("has a need to manage a small team")]),_v(" "),_c('li',[_v("need efficient way to track and manage team members' progress and status")]),_v(" "),_c('li',[_v("does not require online syncing functionality")]),_v(" "),_c('li',[_v("does not require multi-user interactions")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('em',[_v("Based on the AB3 brown-field project")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("Should work on any "),_c('em',[_v("mainstream OS")]),_v(" as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("17")]),_v(" or above installed.")]),_v(" "),_c('li',[_v("Should be able to hold up to 1000 persons without a noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.")]),_v(" "),_c('li',[_v("Should not require a persistent internet connection and be able to use the whole system fully offline and locally.")]),_v(" "),_c('li',[_v("Should minimize data loss to 1-minute worth of user input for resilience in unexpected shutdowns.")]),_v(" "),_c('li',[_v("A user needs to confirm when handling duplicate entries instead of allowing silent overwrites.")]),_v(" "),_c('li',[_v("Should work on both 32-bit and 64-bit operating systems for compatibility inclusion.")]),_v(" "),_c('li',[_v("Should be compatible with Windows, macOS, and Linux for cross-platform usage.")]),_v(" "),_c('li',[_v("Should follow a modular code structure, allowing for future enhancements and maintainability.")]),_v(" "),_c('li',[_v("Should complete all CRUD operations (Add, Remove, Update) within 200 milliseconds.")]),_v(" "),_c('li',[_v("Should retrieve and display a list of 1000 members within 1.5 second.")]),_v(" "),_c('li',[_v("Should generate task status reports within a maximum of 3 seconds.")]),_v(" "),_c('li',[_v("Should prevent accidental data loss by implementing confirmation prompts for deletions.")]),_v(" "),_c('li',[_v("Should support automatic backups at periodic intervals or before performing bulk actions.")]),_v(" "),_c('li',[_v("Should process command inputs in a case-insensitive manner to improve usability.")]),_v(" "),_c('li',[_v("Should provide explicit and user-friendly error messages for troubleshooting.")]),_v(" "),_c('li',[_v("Should provide a user manual detailing all available commands.")]),_v(" "),_c('li',[_v("Should document code using JavaDoc for maintainability by future developers.")]),_v(" "),_c('li',[_v("Should allow data recovery from the last saved state in case of crashes.")]),_v(" "),_c('li',[_v("Should consume less than 200MB of memory during normal operations.")]),_v(" "),_c('li',[_v("Should generate reports in a structured format, ensuring usability with spreadsheet applications.")]),_v(" "),_c('li',[_v("Should include unit tests covering at least 80% of core functionalities.")]),_v(" "),_c('li',[_v("Should encrypt or obfuscate sensitive data if required.")]),_v(" "),_c('li',[_v("Should ensure that commands follow a consistent pattern to reduce user confusion.")]),_v(" "),_c('li',[_v("Should return task search results within 1 second.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("List all persons using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command.")]),_v(" "),_c('li',[_v("Ensure there are no persons with the same details you're about to add.")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/John Doe p/98765432 e/johnd@example.com tele/@john pos/student a/John street, block 123, #01-01")]),_v(" "),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("New contact is added to the list.")]),_v(" "),_c('li',[_v("Details of the added contact shown in the status message.")]),_v(" "),_c('li',[_v("Contact list updated with the new person.")])])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/John Doe p/98765432")]),_v(" (missing required fields)\n"),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("No person is added.")]),_v(" "),_c('li',[_v("Error details shown in the status message.")]),_v(" "),_c('li',[_v("Member list not updated.")])])]),_v(" "),_c('li',[_c('p',[_v("Other incorrect add commands to try:")])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Have at least one person in the address book.")]),_v(" "),_c('li',[_v("View this person using "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command.")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 1 p/91234567 e/johndoe@example.com")]),_v(" "),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("First person's phone and email are updated.")]),_v(" "),_c('li',[_v("Status message shows changes.")])])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 1 t/")]),_v(" (clearing tags) "),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("All tags removed from first person.")]),_v(" "),_c('li',[_v("Status message confirms changes.")])])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 0 n/Invalid")]),_v(" "),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("No changes made.")]),_v(" "),_c('li',[_v("Error shown for invalid index.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Have at least one person with at least one task.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("mark 1 1 completed")]),_v(" "),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("First task of first person marked as completed.")]),_v(" "),_c('li',[_v("Status message confirms change.")])])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("mark 1 1 invalid-status")]),_v(" "),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("No changes made.")]),_v(" "),_c('li',[_v("Error about invalid status.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Have several persons with different names, tags, and tasks.")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find n/ john")]),_v(" "),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("Persons with \"john\" in name displayed.")]),_v(" "),_c('li',[_v("Status shows number of matches.")])])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find t/ friend")]),_v(" "),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("Persons with \"friend\" tag displayed.")])])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find task/ report")]),_v(" "),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("Persons with tasks containing \"report\" displayed.")])])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find n/ john t/ friend")]),_v(" "),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("Persons matching both name and tag criteria displayed.")])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Thu, 3 Apr 2025, 18:19:16 GMT+8]")])])])}
}];
