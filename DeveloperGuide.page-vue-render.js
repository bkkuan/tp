...
with(this){return _c('p',[_c('a',{attrs:{"href":"/tp/docs_markbind%5Clayouts%5Cdefault.html"}},[_c('em',[_v("AB3")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The "),_c('strong',[_v("API")]),_v(" of this component is specified in "),_c('a',{attrs:{"href":"https://github.com/AY2425S2-CS2103-F09-4/tp/tree/master/src/main/java/seedu/address/ui/Ui.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Ui.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(" : "),_c('a',{attrs:{"href":"https://github.com/AY2425S2-CS2103-F09-4/tp/blob/master/src/main/java/seedu/address/logic/Logic.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(" : "),_c('a',{attrs:{"href":"https://github.com/AY2425S2-CS2103-F09-4/tp/blob/master/src/main/java/seedu/address/model/Model.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(" : "),_c('a',{attrs:{"href":"https://github.com/AY2425S2-CS2103-F09-4/tp/blob/master/src/main/java/seedu/address/storage/Storage.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Storage.java")])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("Alternative 1 (current choice):")]),_v(" Saves the entire address book.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Easy to implement.")]),_v(" "),_c('li',[_v("Cons: May have performance issues in terms of memory usage.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Alternative 2:")]),_v(" Individual command knows how to undo/redo by\nitself.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Will use less memory (e.g. for "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete")]),_v(", just save the member being deleted).")]),_v(" "),_c('li',[_v("Cons: We must ensure that the implementation of each individual command are correct.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('em',[_v("{more aspects and alternatives to be added}")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"implementation-of-task-feature"}},[_v("Implementation of Task Feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#implementation-of-task-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The task feature allows users to assign and manage tasks for individual team members. Each "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Person")]),_v(" object can contain multiple "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Task")]),_v(" instances, each having a description, status, and optional due date.")])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"task-status-enum"}},[_v("Task Status Enum"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#task-status-enum","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("We use an "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("enum TaskStatus")]),_v(" to define task states:")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("YET_TO_START")])]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("IN_PROGRESS")])]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("COMPLETED")])])])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Command")]),_v(" "),_c('th',[_v("Description")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("task")])]),_v(" "),_c('td',[_v("Adds a task to a member")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deltask")])]),_v(" "),_c('td',[_v("Deletes a task from a member")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("setduedate")])]),_v(" "),_c('td',[_v("Sets a due date for a specific task")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("updatetask")])]),_v(" "),_c('td',[_v("Updates a task for a member")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("listtasks")])]),_v(" "),_c('td',[_v("Lists tasks for a specific member")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("report")])]),_v(" "),_c('td',[_v("Generates a task completion summary")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Tasks are embedded inside the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Person")]),_v(" model.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("JsonAdaptedPerson")]),_v(" serializes/deserializes the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("tasks")]),_v(" list.")]),_v(" "),_c('li',[_v("Tasks are displayed in the UI when "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("listtasks")]),_v(" is used.")]),_v(" "),_c('li',[_v("All task-related commands extend "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Command")]),_v(" and use dedicated parsers.")])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"task-structure"}},[_v("Task Structure"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#task-structure","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"task-command-execution-flow"}},[_v("Task Command Execution Flow"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#task-command-execution-flow","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("has a need to manage a small team (preferably less than 10)")]),_v(" "),_c('li',[_v("need efficient way to track and manage team members' progress and status")]),_v(" "),_c('li',[_v("does not require online syncing functionality")]),_v(" "),_c('li',[_v("does not require multi-user interactions")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(":")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("help users to categorize members by position, grade, skills, and department for easy tracking")]),_v(" "),_c('li',[_v("help users to assign tasks, break them into subtasks, and track completion as a percentage")]),_v(" "),_c('li',[_v("generate overall statistics for individual members and teams, offering insights into progress and efficiency")])])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("team manager")]),_v(" "),_c('td',[_v("add a member, his/her position, department, roles")]),_v(" "),_c('td',[_v("start tracking my team member progress.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("team manager")]),_v(" "),_c('td',[_v("remove inactive team members")]),_v(" "),_c('td',[_v("keep the team database clean and up-to-date.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("team manager")]),_v(" "),_c('td',[_v("add a task/subtask under a member")]),_v(" "),_c('td',[_v("ensure clarity in responsibilities.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("team manager")]),_v(" "),_c('td',[_v("be able to mark the task as completed/in-progress/yet-to-start")]),_v(" "),_c('td',[_v("check the status of my tasks.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("team manager")]),_v(" "),_c('td',[_v("set due dates for the tasks")]),_v(" "),_c('td',[_v("know what time each task need to be completed by.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("team manager")]),_v(" "),_c('td',[_v("receive a summary of task statuses")]),_v(" "),_c('td',[_v("stay informed.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("team manager")]),_v(" "),_c('td',[_v("quickly search for members’ contacts by name")]),_v(" "),_c('td',[_v("call them easily if there is an urgency.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("access interactive tutorials or help pop-ups")]),_v(" "),_c('td',[_v("quickly learn how to use the app’s features effectively.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("team manager")]),_v(" "),_c('td',[_v("identify gaps in skills required for the Task and the members/departments assigned to it")]),_v(" "),_c('td',[_v("assign more people to the Task to fill up the skill gap.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("team manager")]),_v(" "),_c('td',[_v("search for tasks sorted by their priority levels")]),_v(" "),_c('td',[_v("know which tasks need immediate attention.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("team manager")]),_v(" "),_c('td',[_v("search for tasks by their assigned deadline")]),_v(" "),_c('td',[_v("can know what are the upcoming tasks.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("team manager")]),_v(" "),_c('td',[_v("filter team members by their availability (sorting by number of tasks)")]),_v(" "),_c('td',[_v("assign tasks only to those who are not overloaded.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("team manager")]),_v(" "),_c('td',[_v("edit the position, department, roles of my team members")]),_v(" "),_c('td',[_v("easily organise my team structure when there is a change.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("team manager")]),_v(" "),_c('td',[_v("add skills required for a task")]),_v(" "),_c('td',[_v("know which members/department to assign the task to.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("team manager")]),_v(" "),_c('td',[_v("set priority levels for tasks")]),_v(" "),_c('td',[_v("I knows which task need immediate attention and which task can be handled later.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("team manager")]),_v(" "),_c('td',[_v("set task dependencies (e.g. Task B can only start after Task A is completed)")]),_v(" "),_c('td',[_v("know if the task have been completed in the right order.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("team manager")]),_v(" "),_c('td',[_v("see the task completion percentages (no. of subtasks completed out of total no. of subtasks)")]),_v(" "),_c('td',[_v("easily gauge progress and identify any bottlenecks.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("team manager")]),_v(" "),_c('td',[_v("bulk import member details via a CSV file")]),_v(" "),_c('td',[_v("save time when adding multiple members.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("team manager")]),_v(" "),_c('td',[_v("generate a report showing the team's overall task completion rate")]),_v(" "),_c('td',[_v("present it to stakeholders.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("team manager")]),_v(" "),_c('td',[_v("color-code tasks by priority level")]),_v(" "),_c('td',[_v("easily differentiate between critical and low-priority tasks.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("team manager")]),_v(" "),_c('td',[_v("set reminders for upcoming deadlines")]),_v(" "),_c('td',[_v("ensure my team stays on track and meets important deadlines.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("team manager")]),_v(" "),_c('td',[_v("receive notifications when a task is overdue")]),_v(" "),_c('td',[_v("address delays immediately.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("team manager")]),_v(" "),_c('td',[_v("quickly search for team members by their progress completion state")]),_v(" "),_c('td',[_v("identify and help those who are lagging behind.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("team manager")]),_v(" "),_c('td',[_v("add a task/subtask to a department")]),_v(" "),_c('td',[_v("mass assign tasks to members in that department.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("team manager")]),_v(" "),_c('td',[_v("create subtasks for a  task")]),_v(" "),_c('td',[_v("break down large tasks into smaller, manageable pieces.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("team manager")]),_v(" "),_c('td',[_v("track the hours worked by each member on tasks")]),_v(" "),_c('td',[_v("analyze productivity and effort.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("team manager")]),_v(" "),_c('td',[_v("see statistics comparing the progress of different departments/members")]),_v(" "),_c('td',[_v("identify high-performing department/member.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("customize themes and layouts")]),_v(" "),_c('td',[_v("the app feels personal and meets my visual preferences.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("take an interactive app tour")]),_v(" "),_c('td',[_v("learn features without external help.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("undo accidental deletions")]),_v(" "),_c('td',[_v("critical data isn’t lost.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("enable keyboard shortcuts")]),_v(" "),_c('td',[_v("frequent actions (e.g., Ctrl+S to save) are faster.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Should work on any mainstream OS with specifically Java 17.")]),_v(" "),_c('li',[_v("Should support up to 1 member and their associated tasks with minimal performance degradation.")]),_v(" "),_c('li',[_v("Application should function fully offline with no internet connection.")]),_v(" "),_c('li',[_v("Command input should be case-insensitive and provide informative error messages on incorrect format.")]),_v(" "),_c('li',[_v("Should recover the last known good state if the app crashes unexpectedly.")]),_v(" "),_c('li',[_v("Should allow real-time UI refresh when task status or due date is updated.")]),_v(" "),_c('li',[_v("Should complete most operations (e.g., add, delete, update) within 200ms.")]),_v(" "),_c('li',[_v("Should retrieve and display 1000 records within 1.5s.")]),_v(" "),_c('li',[_v("Should not allow duplicate tasks to be added for a member.")]),_v(" "),_c('li',[_v("Should not allow duplicate members.")]),_v(" "),_c('li',[_v("Should highlight invalid commands with contextual prompts and guide users on correct input format.")]),_v(" "),_c('li',[_v("Should ensure extensibility of task logic by modularizing command parser, validator, and model layers.")]),_v(" "),_c('li',[_v("Should keep memory usage under 200MB during peak load.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Initial launch")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Download the jar file and copy into an empty folder")])]),_v(" "),_c('li',[_c('p',[_v("Double-click the jar file or run file with "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("java -jar TeamScape.jar")]),_v(" (recommended) "),_c('br'),_v(" Expected: Shows the GUI with a set of sample contacts. The window size may not be optimum.")])])])]),_v(" "),_c('li',[_c('p',[_v("Saving window preferences")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Resize the window to an optimum size. Move the window to a different location. Close the window.")])]),_v(" "),_c('li',[_c('p',[_v("Re-launch the app by double-clicking the jar file."),_c('br'),_v("\nExpected: The most recent window size and location is retained.")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"adding-a-member"}},[_v("Adding a member"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#adding-a-member","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Prerequisites:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("List all members using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command.")]),_v(" "),_c('li',[_v("Ensure there are no members with the same details you're about to add.")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/John Doe p/98765432 e/johnd@example.com tele/@john pos/student a/John street, block 123, #01-01")]),_v(" "),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("New contact is added to the list.")]),_v(" "),_c('li',[_v("Details of the added contact shown in the status message.")]),_v(" "),_c('li',[_v("Contact list updated with the new member.")])])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/John Doe p/98765432")]),_v(" (missing required fields)\n"),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("No member is added.")]),_v(" "),_c('li',[_v("Error details shown in the status message.")]),_v(" "),_c('li',[_v("Member list not updated.")])])]),_v(" "),_c('li',[_c('p',[_v("Other incorrect add commands to try:")])])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/John Doe")]),_v(" (missing required fields)")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add p/98765432 e/johnd@example.com")]),_v(" (missing name)")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/John Doe p/invalid e/invalid")]),_v(" (invalid formats)\n"),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(": Similar to previous error case.")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"adding-a-task-to-a-member"}},[_v("Adding a task to a member"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#adding-a-task-to-a-member","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Prerequisites:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Have at least one member in the address book.")]),_v(" "),_c('li',[_v("View this member using "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" or "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find")]),_v(" command.")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("task 1 task/Prepare report, 2025-10-10 10:00, in progress")]),_v(" "),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("Task is added to the first member's task list.")]),_v(" "),_c('li',[_v("Status message shows task was added.")])])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("task 1 task/Book venue")]),_v(" (minimal task) "),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("Task is added with default \"yet to start\" status.")]),_v(" "),_c('li',[_v("Status message confirms addition.")])])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("task 0 task/Invalid task")]),_v(" "),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("No task added.")]),_v(" "),_c('li',[_v("Error shown for invalid index.")])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"editing-a-member"}},[_v("Editing a member"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#editing-a-member","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Prerequisites:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Have at least one member in the address book.")]),_v(" "),_c('li',[_v("View this member using "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command.")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 1 p/91234567 e/johndoe@example.com")]),_v(" "),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("First member's phone and email are updated.")]),_v(" "),_c('li',[_v("Status message shows changes.")])])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 1 t/")]),_v(" (clearing tags) "),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("All tags removed from first member.")]),_v(" "),_c('li',[_v("Status message confirms changes.")])])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 0 n/Invalid")]),_v(" "),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("No changes made.")]),_v(" "),_c('li',[_v("Error shown for invalid index.")])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"setting-due-date-for-a-task"}},[_v("Setting due date for a task"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#setting-due-date-for-a-task","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Prerequisites:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Have at least one member with at least one task.")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("setduedate 1 taskint/1 due/2026-02-28 23:59")]),_v(" "),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("Due date set for first task of first member.")]),_v(" "),_c('li',[_v("Status message confirms change.")])])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("setduedate 1 taskint/1 due/2020-01-01 00:00")]),_v(" (past date) "),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("No changes made.")]),_v(" "),_c('li',[_v("Error message shown.")])])]),_v(" "),_c('li',[_c('p',[_v("Other incorrect commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("setduedate 1 taskint/1 due/2025-10-10")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("setduedate 1 /taskint 1 due/2025-10-10 23:59")]),_v(" "),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("Error message similar to that of point 2.")])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"listing-tasks-assigned-to-a-member"}},[_v("Listing tasks assigned to a member"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#listing-tasks-assigned-to-a-member","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Prerequisites:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Have at least one member with tasks.")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("listtasks 1")]),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("Tasks for first member displayed.")]),_v(" "),_c('li',[_v("Status bar shows command success.")])])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("listtasks 0")]),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("No tasks shown.")]),_v(" "),_c('li',[_v("Error about invalid index.")])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"deleting-a-task-under-a-member"}},[_v("Deleting a task under a member"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#deleting-a-task-under-a-member","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Prerequisites:")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deltask 1 1")]),_v(" "),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("First task of first member deleted.")]),_v(" "),_c('li',[_v("Status message confirms deletion.")])])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deltask 1 0")]),_v(" "),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("No task deleted.")]),_v(" "),_c('li',[_v("Error about invalid index.")])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"updating-task-for-a-member"}},[_v("Updating task for a member"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#updating-task-for-a-member","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Prerequisites:")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("updatetask 1 1 completed")]),_v(" "),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("First task of first member updated as completed from its previous state.")]),_v(" "),_c('li',[_v("Successful message confirms update and shows new task details.")])])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("updatetask 3 2 project milestone 1 sprint, 2025-05-12 10:00, in progress")]),_v(" "),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("Third task of second person updated as completed from its previous state.")]),_v(" "),_c('li',[_v("Successful message to confirm update and shows new task details.")])])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("updatetask 3 2 project milestone 1 sprint, invalidDateorTaskStatus")]),_v(" "),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("No change to the specified task")]),_v(" "),_c('li',[_v("Error message shows specific error.")])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"finding-members"}},[_v("Finding members"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#finding-members","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Prerequisites:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Have several members with different names, tags, and tasks.")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find n/ john")]),_v(" "),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("Members with \"john\" in name displayed.")]),_v(" "),_c('li',[_v("Status shows number of matches.")])])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find t/ friend")]),_v(" "),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("Members with \"friend\" tag displayed.")])])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find task/ report")]),_v(" "),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("Members with tasks containing \"report\" displayed.")])])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find n/ john t/ friend")]),_v(" "),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("Members matching both name and tag criteria displayed.")])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"generating-task-status-report"}},[_v("Generating Task Status Report"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#generating-task-status-report","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Prerequisites:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Have several members with tasks in different statuses.")]),_v(" "),_c('li',[_v("Tasks should be categorized into statuses: Yet to Start, In Progress, and Completed.")]),_v(" "),_c('li',[_v("Member should have at least one task to be included in the report.")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("report")]),_v(" "),_c('br'),_v(" "),_c('strong',[_v("Expected")]),_v(":\n"),_c('ul',[_c('li',[_v("A summary report is displayed, grouping tasks by their status (Yet to Start, In Progress, Completed).")]),_v(" "),_c('li',[_v("Each status section shows the number of member with tasks in parentheses.")]),_v(" "),_c('li',[_v("Member under each status have their tasks listed in the order they were assigned.")]),_v(" "),_c('li',[_v("Status bar confirms successful execution")])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"deleting-a-member"}},[_v("Deleting a member"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#deleting-a-member","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Deleting a member while all members are being shown")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: List all members using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Multiple members in the list.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 1")]),_c('br'),_v("\nExpected: First contact is deleted from the list. Details of the deleted contact shown in the status message. Timestamp in the status bar is updated.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 0")]),_c('br'),_v("\nExpected: No member is deleted. Error details shown in the status message. Status bar remains the same.")])]),_v(" "),_c('li',[_c('p',[_v("Other incorrect delete commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete x")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("...")]),_v(" (where x is larger than the list size)"),_c('br'),_v("\nExpected: Similar to previous.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Mon, 7 Apr 2025, 3:01:38 GMT+8]")])])])}
}];
