...
with(this){return _c('ol',[_c('li',[_v("Should work on any mainstream OS with specifically Java 17.")]),_v(" "),_c('li',[_v("Should support up to 1 person and their associated tasks with minimal performance degradation.")]),_v(" "),_c('li',[_v("Application should function fully offline with no internet connection.")]),_v(" "),_c('li',[_v("Command input should be case-insensitive and provide informative error messages on incorrect format.")]),_v(" "),_c('li',[_v("Should recover the last known good state if the app crashes unexpectedly.")]),_v(" "),_c('li',[_v("Should allow real-time UI refresh when task status or due date is updated.")]),_v(" "),_c('li',[_v("Should complete most operations (e.g., add, delete, update) within 200ms.")]),_v(" "),_c('li',[_v("Should retrieve and display 1000 records within 1.5s.")]),_v(" "),_c('li',[_v("Should not allow duplicate tasks to be added for a person.")]),_v(" "),_c('li',[_v("Should not allow duplicate persons.")]),_v(" "),_c('li',[_v("Should highlight invalid commands with contextual prompts and guide users on correct input format.")]),_v(" "),_c('li',[_v("Should ensure extensibility of task logic by modularizing command parser, validator, and model layers.")]),_v(" "),_c('li',[_v("Should keep memory usage under 200MB during peak load.")])])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"adding-a-task-to-a-person"}},[_v("Adding a task to a person"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#adding-a-task-to-a-person","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Prerequisites:")])])}
},function anonymous(
...
with(this){return _c('h3',{attrs:{"id":"updating-task-for-a-person"}},[_v("Updating task for a person"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#updating-task-for-a-person","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Prerequisites:")])])}
},function anonymous(
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Mon, 7 Apr 2025, 1:39:53 GMT+8]")])])])}
}];
